...
query Z_add_Arth_goal4 {
    fixes z1: int32u;
    fixes z2: int32u;
    assumes 0 <= z1 && z1 <= z2;
    assumes z2 <= 1073741823;
    shows x + y == x + y
    proof { auto }
} 

query Z_add_Arth_goal5 {
    fixes z1: int32u;
    assumes z1 <= 100;
    shows z1 + 10 <= 120;
    proof { auto }
...
query Z_sub_Arth_goal1 {
    fixes z1: int32u;
    fixes z2: int32u;
    assumes 0 < z1;
    assumes z1 < z2;
    shows (z2 - z1 + z1) + (z2 - z1) == z1;
    proof { auto }
}